...
def criar_graficos(df_filtrado):
   ...
   with col3:
       fig_box_m2 = go.Figure()
       fig_box_m2.add_trace(go.Box(
           y=df_filtrado['preco_m2'],
           name='Preço/m²',
           hovertemplate="<b>Preço/m²:</b> R$ %{y:.2f}/m²<extra></extra>"
       ))
       fig_box_m2.update_layout(
           title='Distribuição dos Preços por m²',
           yaxis_title='Preço por m² (R$)'
       )
       st.plotly_chart(fig_box_m2, use_container_width=True)
